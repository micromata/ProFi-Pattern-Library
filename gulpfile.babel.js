...
import patternLibrary from './gulp/tasks/pattern-library';
 ...
 */
export {test, lint, serve, webpackWatch};
...
export function watch() {
	...
	gulp.watch(settings.sources.patternLibrary, gulp.series(patternLibrary, reload)).on('change', informOnChange);
